# ------------------------------------------------------------------------------
# Michael Rogers Python EE Calculator ------------------------------------------
# ------------------------------------------------------------------------------
...
title = """	
  ...
  / __/ / __/    / /   / __ `/ / ___/
 / /___/ /___   / /___/ /_/ / / /__ Vim 
/_____/_____/   \____/\__,_/_/\___/ Edition 
"""
...
#    --------------------------
margin_window = Window(BufferControl(buffer=margin_buffer), width=4)
